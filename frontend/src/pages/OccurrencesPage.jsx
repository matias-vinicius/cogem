...
export default function OccurrencesPage() {
  ...
  const canManageStatus = ['admin', 'manager', 'concierge', 'maintenance'].includes(user.role)
  ...
  return (
    <div className="page">
      ...
      <section className="workflow-ribbon"><div className="workflow-intro"><Wrench /><span><small>FLUXO DE ATENDIMENTO</small><strong>Da abertura à solução com rastreabilidade</strong></span></div><div className="workflow-steps"><span className="is-complete"><i>1</i>Ocorrência aberta</span><span className="is-current"><i>2</i>Triagem responsável</span><span><i>3</i>Atendimento</span><span><i>4</i>Conclusão</span></div></section>
